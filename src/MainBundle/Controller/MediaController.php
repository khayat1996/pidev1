...
class MediaController extends Controller
{
    ...
    {
        $medium = new Media();
        $form = $this->createForm('MainBundle\Form\MediaType', $medium);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('media_show', array('idMedia' => $medium->getIdmedia()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('MainBundle\Form\MediaType', $medium);
    ...
    private function createDeleteForm(Media $medium)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('media_delete', array('idMedia' => $medium->getIdmedia())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
