...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $notes = $em->getRepository('MainBundle:Note')->findAll();
    ...
    {
        $note = new Note();
        $form = $this->createForm('MainBundle\Form\NoteType', $note);
    ...
    {
        $deleteForm = $this->createDeleteForm($note);
        $editForm = $this->createForm('MainBundle\Form\NoteType', $note);
